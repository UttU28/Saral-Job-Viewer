...
export function HomePage() {
  ...
  const methods = Array.from(new Set(["all", ...jobs.map(job => job.method)]));
  const types = Array.from(new Set(["all", ...jobs.map(job => job.jobType)]));
      ...
      <div className="container mx-auto px-4 py-4 max-w-5xl">
        ...
        <div className="mt-6 space-y-8">
          {loading ? (
            ...
            <>
              <JobSection
                title="Dekh le jo pasand aaye wo"
                jobs={availableJobs}
