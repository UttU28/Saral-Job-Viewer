...
function reasonMessage(status: GmailStatus | null): string {
  ...
  if (status.reason === "missingScopes") {
    return "Gmail needs re-authorization for label changes (gmail.modify). Disconnect/reconnect Gmail to apply BaharMil, oneSided, jobAds, pendingJobs, and shopping.";
  }
